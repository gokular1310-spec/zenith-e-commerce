  ...
  return (
    <div className="bg-gray-800 shadow-lg rounded-lg p-6">
      ...
      {conversations.length === 0 ? (
        <p className="text-gray-400 text-center py-8">No conversations found related to your products.</p>
      ) : (
        <div className="space-y-4">
          {conversations.map(convo => (
            <Link key={convo.id} to={`/sub-admin/messages/${convo.id}`} className="block bg-gray-700 rounded-lg p-4 shadow-md hover:bg-gray-600 transition-colors duration-200">
